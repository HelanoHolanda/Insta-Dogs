...
import Icone from "../../Public/adicionar.svg";
import Icone1 from "../../Public/feed.svg";
  ...
  return (
    <>
      ...
      >
        ...
        >
          <img className="inline-block" src={Icone1} alt="Feed" />
          {mobile && "Minhas Fotos"}
        </NavLink>
        ...
        >
          <img className="inline-block" src={Icone} alt="Feed" />
          {mobile && "Postar Foto"}
        </NavLink>
